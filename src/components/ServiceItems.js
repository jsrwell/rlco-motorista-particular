	...
	return (
		<div className="row g-5" id="serviceItems">
			<div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
				<div className="service-item p-4">
					<div className="overflow-hidden mb-4">
						<img className="img-fluid" src="assets/img/corporate-trip.jpg" alt="Viagens Corporativas" />
					</div>
			...
			<div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
				<div className="service-item p-4">
					<div className="overflow-hidden mb-4">
						<img className="img-fluid" src="assets/img/aeroport-trip.jpg" alt="Traslados Aeroportuários" />
					</div>
			...
			<div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.7s">
				<div className="service-item p-4">
					<div className="overflow-hidden mb-4">
						<img className="img-fluid" src="assets/img/leisure-trip.jpg" alt="Viagens de Lazer" />
					</div>
