			...
			<div className="container py-5">
				...
				<div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
					{[1, 2, 3, 4].map((testimonial, index) => (
						<div className="testimonial-item p-4 my-5" key={index}>
							<i className="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
							<div className="d-flex align-items-end mb-4">
								<img className="img-fluid flex-shrink-0" src={`img/testimonial-${testimonial}.jpg`} style={{ width: '80px', height: '80px' }} alt={`testimonial-${testimonial}`} />
								<div className="ms-4">
